...
private[kafka] class ZookeeperConsumerConnector(val config: ConsumerConfig,
 ...
 // for java client
  def createMessageStreams[T](
    ...
    val scalaTopicCountMap: Map[String, Int] = Map.empty[String, Int] ++ asJavaMap(topicCountMap.asInstanceOf[java.util.Map[String, Int]])
  ...
  def createMessageStreamsByFilter[T](topicFilter: TopicFilter, numStreams: Int, decoder: Decoder[T]) =
    asJavaList(underlying.createMessageStreamsByFilter(topicFilter, numStreams, decoder))
